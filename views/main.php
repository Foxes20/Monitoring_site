    ...
    <div class="row">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link " id="service-ip-tab" data-bs-toggle="tab" data-bs-target="#service-ip" type="button" role="tab" aria-controls="service-ip" aria-selected="true">Проверка IP</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="port-tab" data-bs-toggle="tab" data-bs-target="#port" type="button" role="tab" aria-controls="port" aria-selected="false">Проверка портов</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            <!--      **********************          ip              *******************************-->
            <div class="tab-pane fade show " id="service-ip" role="tabpanel" aria-labelledby="service-ip-tab">
                <div style="width:900px; margin:0 auto;">
                    <div style="border:1px solid #E1E4E9; box-shadow:0 0 5px #C8C8C8; margin:20px;padding:40px; ">
                        <h2>Geo IP — узнайте местоположение по IPv4 </h2>
                        <div class="container">
                            <div class="row">
                                <div class="col-6">
                                    <form id="form_ip" action="//http://dev.trustik.ru/?path=service_ip" method="POST"  name="servIP">
                                        <div class="formaIp">
                                            ...
                                            <input type="text" id="input_ip" name="check_ip"><br><br><!-- data-ip="<?=$ip?>" -->
            ...
            <!--   ***********************    end ip      *******************************  -->
            <div class="tab-pane fade show active" id="port" role="tabpanel" aria-labelledby="port-tab">
                <style>
                    .inpPort, .inpServer{width:310px; height:50px;}
                </style>
                <form action="service_port.php" method="POST" name="port" class="port" id="PortCeck">
                    <div class="container">
                        <div style="width:900px; margin:0 auto;">
                            <div style="border:1px solid #E1E4E9; box-shadow:0 0 5px #C8C8C8; margin:20px;padding:40px; ">
                                <div class="row ">
                                    <h2>Проверка доступных портов IPv4</h2>
                                    <div class="col-7">
                                        <p>Port:</p>
            ...
            <div class="tab-pane fade" id="monitoring" role="tabpanel" aria-labelledby="monitoring-tab">
                <div class="conteiner">
                    <div style="width:900px; margin:0 auto;">
                        <div style="border:1px solid #E1E4E9; box-shadow:0 0 5px #C8C8C8; margin:20px;padding:40px; ">
                            <h3 class="mb-5">Проверить доступность сайта IPv4</h3>
                            <div class="contain-form mb-5">
                                <form action="/?url=request_monitoring" method="POST" id="form_monitoring" name="form_check_monitoring">
                                ...
                                <div class="d-none pin">
                                    ...
                                    <form action="/?url=request_monitoring" method="POST" id="form_ping" name="form_check_ping">
                                        <div>
...
<script src="/service_ip.js?001"></script>
